  ...
  <footer class="bg-gray-900 text-gray-300 mt-auto">
    <div class="container-custom py-12">
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
          <div class="flex items-center gap-2 mb-4">
            ...
            <span class="text-xl font-bold text-white">NewsFeed</span>
          </div>
          <p class="text-sm">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li>
              <router-link to="/news" class="hover:text-primary-400 transition-colors">
                Browse News
              </router-link>
            </li>
            <li>
              <router-link v-if="authStore.isAuthenticated" to="/news/create" class="hover:text-primary-400 transition-colors">
                Create News
              </router-link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <template v-if="authStore.isAuthenticated">
              <li>
                <router-link to="/profile" class="hover:text-primary-400 transition-colors">
                  My Profile
                </router-link>
              </li>
              <li>
                <router-link to="/profile/edit" class="hover:text-primary-400 transition-colors">
                  Settings
                </router-link>
              </li>
            </template>
            <template v-else>
              <li>
                <router-link to="/login" class="hover:text-primary-400 transition-colors">
                  Sign In
                </router-link>
              </li>
              <li>
                <router-link to="/register" class="hover:text-primary-400 transition-colors">
                  Sign Up
                </router-link>
              </li>
            </template>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-sm">
          © {{ currentYear }} NewsFeed. All rights reserved.
        </p>
